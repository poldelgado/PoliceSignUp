...
def inscription_form():
    ...
    pdf.line(30,37,30,345)
    pdf.line(200,37,200,345)
    pdf.line(30,345,200,345)
    pdf.line(30,75,200,75)
    pdf.line(120,37,120,75)
    pdf.line(30,300,200,300)
    pdf.dashed_line(35,65,115,65) #FIRMA CONTROLADOR FORMULARIO
    pdf.dashed_line(138,339,198,339) #FIRMA CONTROLADOR FISICO
    ...
    pdf.text(34,175,unicode('CORREO ELECTRÓNICO: ','utf-8') + unicode(inscription.auth_user.email,'utf-8'))
    pdf.text(34,180, unicode('TÍTULO SECUNDARIO EXPEDIDO POR: ' + inscription.auth_user.high_school,'utf-8'))
    pdf.text(34,185, unicode('TÍTULO TERCIARIO: ' + inscription.auth_user.tertiary_title,'utf-8'))
    pdf.text(44,310, unicode('ESTOS DATOS SERÁN COMPLETADOS POR PERSONAL DEL I.E.S.P "G.J.F.S.M"','utf-8'))
    pdf.text(34,317, 'ESTATURA:..........')
    pdf.text(34,324, 'PESO:..............')
    pdf.text(34,331, 'I.M.C.:............')
    pdf.set_xy(34,215)
    pdf.multi_cell(160,5, declaracion_jurada,0,'J',False)

    pdf.set_font('Times','',9)
    pdf.text(34,270,unicode('FIRMA DEL ASPIRANTE AL MOMENTO DE PRESENTAR LA DOCUMENTACIÓN: ..........................................................','utf-8'))
    pdf.text(34,278,unicode('ACLARACIÓN: .................................................................................................................................................................................','utf-8'))
    #pdf.set_xy(34,320)
    #pdf.multi_cell(160,5, aclaracion,0,'J',False)
    pdf.text(140,342, 'FIRMA Y SELLO DEL CONTROLADOR')
