...
def inscription_form():
    ...
    pdf.image(logoMinSeg,45,13,80,20)
    #VARIABLES
    enc_intelectual = unicode('FORMULARIO DE EXAMENES DE CONOCIMIENTOS INTELECTUALES PARA ASPIRANTES A CADETES DE PRIMER AÑO DEL INSTITUTO DE ENSEÑANZA SUPERIOR DE POLICÍA "GRAL. JOSÉ FRANCISCO DE SAN MARTÍN"','utf-8')
    ...
    pdf.text(33,256,unicode('ACLARACIÓN...........................................................................................................................................................','utf-8'))
    pdf.text(33,264,unicode('FIRMA DEL ASPIRANTE.........................................................................................................................................','utf-8'))
    ...
    pdf.set_xy(156,165)
    pdf.multi_cell(41,4,unicode('FORMACIÓN ÉTICA Y CIUDADANA','utf-8'),0,'C',False)
    ...
    if age < 18:
        ...
        pdf.dashed_line(33,208,185,208)
        pdf.dashed_line(30,273,90,273)
        
        pdf.set_font('Times','B',10)
        pdf.text(90,212,'(Lugar y fecha)')
        ...
        pdf.set_font('Arial', 'B', 12)
        pdf.set_xy(30,190)
        pdf.multi_cell(155,5,certificacion2,0,'C',False)
        pdf.set_font('Times','',12)
        pdf.set_xy(30,220)
        pdf.multi_cell(155,6,suscribe,0,'',False)
