...
'Abs Test': 'Fuerza Flexora de Tronco',
'ABS Test': 'Fuerza Flexora de Tronco',
'abs_test': 'prueba de zona media',
'Access Control': 'Control de Acceso',
'Add': 'Añadir',
'Add Record': 'Agregar Registro',
'Add record to database': 'Agregar Registro a Base de Datos',
'Add this to the search as an AND term': 'Agrega esto a la busqueda como un término AND',
'Add this to the search as an OR term': 'Agrega esto a la busqueda como un término OR',
...
'Aerobics': 'Potencia Aeróbica 1500 mts.',
'aerobics': 'resistencia',
...
'Auth events': 'Eventos Auth',
'Auth groups': 'Grupos Auth',
'Auth memberships': 'Membresias Auth',
'Auth permissions': 'Permisos Auth',
'Auth User': 'Auth User',
...
'cancel': 'cancelar',
'Candidate': 'Aspirante',
'Candidate Inscription': 'Inscripción de Aspirante',
'Candidate Inscriptions': 'Inscripciones',
...
'Confirm Notification': 'Confirme Notificacion',
'Confirm Password': 'Confirmar Contraseña',
'Confirm Post': 'Confirmar Noticia',
'contains': 'contiene',
'content': 'contenido',
'Content': 'Contenido',
'Context': 'Contexto',
...
'Copyright': 'Copyright',
'Create': 'Crear',
'Create Candidate': 'Crear Aspirante',
'Create Category': 'Crear Categoría',
'create file with filename:': 'cree archivo con nombre:',
'Create Inscription': 'Crear Inscripción',
'Create New': 'Nuevo/a',
...
'date of post': 'Fecha de la noticia',
'Date Of Post': 'Fecha de Noticia',
'DB': 'BDD',
'db': 'bdd',
'DB Model': 'Modelo BDD',
...
'Enter a valid email address': 'Ingresar un correo electrónico válido',
...
'Enter date as %(format)s': 'Ingrese fecha como %(format)s',
...
'exam result': 'Resultado del Exámen',
'Exam Result': 'Resultado del Exámen',
'Exam Results': 'Resultados del Exámen',
'Exams': 'Examenes',
'Exams Schedule': 'Cronograma de Exámenes',
...
'Fill empty fields': 'Rellena los campos vacíos',
'First name': 'Nombre',
'First Year Cadet Candidate': 'Aspirante a Cadete de Primer Año',
'Firstname': 'Nombre',
...
'Gender': 'Genero',
'Geography': 'Geografía',
'GPE': 'Exámen Psicologico Grupal',
'Graduation': 'Promoción',
'Graduation Number': 'Numero de Promoción',
'Graduations': 'Graduados',
...
'Groupal Psychological Examination': 'Exámen Psicológico Grupal',
'Groupal Psychological Examination Schedule': 'Groupal Psychological Examination Schedule',
'Groupal Psychological Examinations': 'Examinacion Psycologica Grupal',
'Groups': 'Grupos',
'Height': 'Altura',
'height': 'altura',
'Height Exam': 'Exámen de Altura',
'Height Examinations': 'Examenes de Altura',
'Height Schedule': 'Cronograma de Exámenes de Altura',
'Heights': 'Alturas',
'Hello World': 'Hola Mundo',
'help': 'ayuda',
'High School': 'Colegio Secundario',
'history': 'historia',
'History': 'Historia',
'Home': 'Inicio',
'Hour': 'Hora',
...
'Inscription': 'Inscripcion',
'Inscription Date': 'Fecha de Inscripcion',
'Inscription Id': 'Id de Inscripción',
'Insert GPE': 'Insertar Exámen Psicologico Grupal',
'Insert GPE Results': 'Insertar Resultados del Exámen Grupal Psicológico',
'Insert Heights Results': 'Insertar Resultados del Exámen de Altura',
'Insert Intellectual Exams Results': 'Insertar Resultados de Exámenes Intelectuales',
'Insert Medical Exam Results': 'Insertar Resultados Médicos',
'insert new': 'inserte nuevo',
'insert new %s': 'inserte nuevo %s',
'Insert New Schedule': 'Insertar Nuevo Cronograma',
...
'Insert Shifts': 'Insertar Turnos',
'Installed applications': 'Aplicaciones instaladas',
'Insufficient privileges': 'Privilegios insuficientes',
'Intellectual Exam': 'Exámen Intelectual',
'Intellectual Exam Schedule': 'Cronograma de Exámen Intelectual',
'Intellectual Exams': 'Examen Intelectual',
...
'Lanzar Inscripciones Nuevas': 'Lanzar Nuevas Inscripciones',
'Last name': 'Apellido',
'Last Posts': 'Ultimas Noticias',
'Last saved on:': 'Guardado en:',
'Last Updated': 'Ultima Actualización',
'Lastname': 'Apellido',
'Lastname, Firstname': 'Apellido y Nombre',
'Latest News': 'Ultimas Noticias',
'Latest Posts': 'Ultimas Noticias',
'Launch': 'Lanzar',
'Launch GPE': 'Lanzar EGP',
'Launch GPE Exam': 'Lanzar EGP',
'Launch Heights Exams': 'Lanzar Examen de Estatura',
'Launch Heights Results': 'Habilitar Resultados de Estatura',
'Launch Intelectual Exam': 'Lanzar Exámen Intelectual',
'Launch Intellectual Exam': 'Lanzar Exámen Intelectual',
'Launch Medical Exam': 'Lanzar Exámen Médico',
'Launch New GPE': 'Lanzar EPG',
'Launch New Intellectual Exam': 'Lanzar Exámen Intelectual',
'Launch New Medical Exam': 'Lanzar Exámen Médico',
'Launch New Physical Exam': 'Lanzar Exámen Físico',
'Launch New Psychological Interview': 'Lanzar Entrevista Psicológica',
'Launch Physical Exam': 'Lanzar Exámen Fisico',
'Launch Psychological Interview': 'Lanzar Entrevista Psicológica',
'Launch Psychological Inteview': 'Lanzar Entrevistas Psicológicas',
...
'list': 'lista',
'List': 'Lista',
'Lista de Aprobados': 'Lista de Aprobados',
...
'Manage Auth': 'Gestionar Auth',
'Manage Cache': 'Gestionar la Caché',
'Manage Content': 'Gestionar Contenido',
'Manage Database': 'Gestionar Bases de Datos',
'Manage Users': 'Gestionar Usuarios',
'Marital Status': 'Estado Civil',
'Marital Status:': 'Estado Civil:',
'married': 'casado/a',
'Medical Exam': 'Exámen Médico',
'Medical Exam Schedule': 'Cronograma de Exámenes Médicos',
'Medical Exams': 'Exámenes Médicos',
'Memberships': 'Membresias',
'Memberships(created_by)': 'Membrsias(created_by)',
'Memberships(modified_by)': 'Membresias(modified_by)',
'Memberships(user_id)': 'Membresias(user_id)',
'Membresias(created_by)': 'Membresias(creado_por)',
'Membresias(modified_by)': 'Membresias(modificado_por)',
'Membresias(user_id)': 'Membresias(user_id)',
...
'News Categories': 'Nuevas Categorias',
'Next': 'Siguiente',
...
'Penitentiary Service Candidate': 'Aspirante al Servicio Penitenciario',
'Permission': 'Permiso',
'Permissions': 'Permisos',
'Phone': 'Teléfono Fijo',
'Phone:': 'Telefono Fijo:',
'Physical Exam': 'Exámen Físico',
'Physical Exam Schedule': 'Cronograma de Exámen Físico',
'Physicals Exams': 'Exámenes Físicos',
'please complete the address field': 'por favor complete el campo de dirección',
'Please complete the address field': 'Por favor complete la dirección',
'please complete the city field': 'por favor complete la ciudad',
'Please complete the city field': 'Por favor complete la ciudad',
'Please complete the high school field': 'Por favor complete la institución secundaria de donde egresó',
'Please complete the mobile phone field': 'Por favor complete el Teléfono Celular',
'please complete the phone field': 'por favor complete el teléfono fijo',
'Please complete the phone field': 'Por favor complete el teléfono',
'Please complete this information': 'Please complete this information',
'please input your password again': 'por favor introduzca su contraseña otra vez',
'please insert only numbers': 'por favor ingrese solo números',
'please insert only numbers, minimum 8 numbers': 'por favor, ingresar solo números, el DNI deberá tener minimo 8 números.',
'Please select some option': 'Por favor elija una opción',
'Plugins': 'Plugins',
'Police Station': 'Comisaría Jurisdiccional',
'Post': 'Noticia',
'Post Date': 'Fecha de Noticia',
'Posts': 'Noticias',
'Powered by': 'Este sitio usa',
'Preface': 'Prefacio',
'Previous': 'Anterior',
'previous %s rows': 'filas %s previas',
...
'Province': 'Provincia',
'Psychological Interview': 'Entrevista Psicológica',
'Psychological Interview Schedule': 'Cronográmas de Entrevistas Psicologicas',
'Psycological Interview': 'Entrevista Psicologica',
'Psycological Interview Schedule': 'Cronograma de Entrevista Psicológica',
'Psycological Interviews': 'Entrevista Psicológica',
'Python': 'Python',
...
'shell': 'terminal',
'Shift': 'Turno',
'Shift Assignment': 'Asignacion de Turno',
'Shift Date': 'Fecha de Turno',
'Shifts': 'Turnos',
'Shifts Assignment': 'Asignacion de Turnos',
...
'spanish_language': 'lengua_española',
...
'SSN:': 'D.N.I:',
'start': 'inicio',
'Start building a new search': 'Comienza una nueva busqueda',
...
'submit': 'enviar',
'Success!': '¡Correcto!',
'Successfuly saved': 'Guardado Exitosamente',
...
'Tertiary Title': 'Título Terciario / Universitario',
'test': 'probar',
...
'Twitter': 'Twitter',
'Ud. debe tener 18 años cumplidos y hasta 24 años al 01/03/2019': 'Ud. debe tener 18 años cumplidos y hasta 24 años al 01/03/2019',
...
'Value already in database or empty': 'El valor ya existe en la base de datos o esta vacio',
'value not allowed': 'valor no permitido',
'Value not allowed': 'Valor no permitido',
'value not in database': 'el valor no está en la base de datos',
'Ver Aspirantes': 'Ver Aspirantes',
...
'View Candidates': 'Ver Aspirantes',
'View Categories': 'Ver Categorias',
'View GPE': 'Ver Exámenes Psicológico Grupal',
'View Heights Exams': 'Ver Examen de Altura',
'View Inscriptions': 'Ver Inscripciones',
'View Intellectuals Exams': 'Ver Exámenes Intelectuales',
'View Medical Exams': 'Ver Exámenes Médicos',
'View Notification': 'Ver Notificacion',
'View Notifications': 'Ver Noticicaciones',
'View Owners': 'Ver Propietarios',
'View Physicals Exams': 'Ver Exámenes Físicos',
'View Post List': 'Ver Lista de Notiicass',
'View Posts': 'Ver Noticias',
'View Schedules': 'Ver Cronogramas',
'View Shifts': 'Ver Turnos',
'views': 'vistas',
'Views': 'Vistas',
...
'Year of Graduation': 'Año de Promoción',
'YES': 'SÍ',
...
'¡Debe ser dd/mm/aaaa': '¡Debe ser dd/mm/aaaa',
