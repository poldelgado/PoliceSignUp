...
db.auth_user.birth_date.requires = IS_DATE_IN_RANGE(format=T('%Y-%m-%d'), minimum=datetime.date(1994,3,2), maximum=datetime.date(2001,3,1),error_message='Ud. debe tener 18 años cumplidos y menos de 24 años al 01/03/2019')
