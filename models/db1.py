...
db.auth_user.birth_date.requires = IS_DATE_IN_RANGE(format=T('%Y-%m-%d'), minimum=datetime.date(1993,1,31), maximum=datetime.date(2000,2,1),error_message='Ud. debe tener 18 años cumplidos y menos de 24 años al 01/02/2018')
